  ...
  background-color: #0069d9;
    ...
    <body>
      ...
      <?php include 'top bar.php';?>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            <a href="player_see_team.php" class="nav-item nav-link">Back</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <!-- Nav Bar End -->
    <?php 
  $query = mysqli_query($conn, "SELECT * FROM player_info WHERE Player_ID='$playerid'");
                            ...
                            <div class="row mb-5 gx-5">
                               ...
                               <div class="col-xxl-4">
                                    <div class="bg-secondary-soft rounded">
                                        <div class="row g-3">
                                            <h4 class="mb-4 mt-0">Profile Image</h4></br></br>
