    ...
    <div class="container">
        ...
        <div class="col-md-6 offset-md-3 text-center">
            <div class="input-group">
              <input type="text" name="searchTerm" class="form-control border border-primary border-rounded" placeholder="Enter The Team Name" ><br>
    ...
    <table class="table table-borderless text-center">
        ...
        <?php 
                  if (isset($_POST['searchButton'])) {
                    ...
                    $query = "SELECT * FROM team WHERE venue LIKE '%$key%'";
                }
                else{
...
{ 
  ?>
          ...
          <td><?php echo $result['ID'];?></td>
           ...
           <td> 
           <a href="admin_see&update_team.php?ID=<?php echo $result['ID']; ?>"class="btn btn-success btn-lg mr-2 mb-1 ">View</a> 
           <a href="admin_update_team.php?ID=<?php echo $result['ID']; ?>"class="btn btn-danger btn-lg">Delete</a> 
          </tr>
          <?php } ?> 
        </tbody>
      </table>
...
if(isset($_GET['ID'])) {
    ...
    if(isset($id)) {
      ...
      if(mysqli_query($conn, $sql)) {
        $success_message = "Team Delete successfully";
        echo '<script>
                Swal.fire({
                  position: "center",
                  icon: "success",
